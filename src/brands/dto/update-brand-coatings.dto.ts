...
export class UpdateBrandCoatingItemDto {
  @Type(() => Number)
  @IsInt()
  @Min(1)
  coatingId: number;
...
export class UpdateBrandCoatingsDto {
  @IsArray()
  @ArrayUnique((item: UpdateBrandCoatingItemDto) => item.coatingId)
  @ValidateNested({ each: true })
  @Type(() => UpdateBrandCoatingItemDto)
  coatings: UpdateBrandCoatingItemDto[];
}
