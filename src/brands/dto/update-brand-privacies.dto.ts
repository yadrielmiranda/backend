...
export class UpdateBrandPrivacyItemDto {
  @Type(() => Number)
  @IsInt()
  @Min(1)
  privacyId: number;
...
export class UpdateBrandPrivaciesDto {
  @IsArray()
  @ArrayUnique((item: UpdateBrandPrivacyItemDto) => item.privacyId)
  @ValidateNested({ each: true })
  @Type(() => UpdateBrandPrivacyItemDto)
  privacies: UpdateBrandPrivacyItemDto[];
}
